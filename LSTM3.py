...
# IMPORTANT:
# Change this exact column name if Excel/Python reads it slightly differently
target_column = "Netzlast [MWh] Berechnete Auflösungen"

# If your file uses German thousands separator like 44.101,92
...
# Since target is the same demand column, make separate y scaler
...
# --------------------------------------------------
# 12. Inverse transform to real demand values
# --------------------------------------------------
...
# --------------------------------------------------
# 13. Plot scaled values
# --------------------------------------------------

plt.figure(figsize=(12, 5))
plt.title("Predicted vs Actual Demand (scaled values)")
...
plt.figure(figsize=(12, 5))
plt.title("Predicted vs Actual Demand (real values)")
